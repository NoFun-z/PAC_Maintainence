...
{
    public class MemberRenewalNotify
    {
        public static string MemberMinTemp(string MemberEmail)
        {
          ...
          <table class=""email-content"" width=""100%"" cellpadding=""0"" cellspacing=""0"" role=""presentation"" style=""width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;"">
            <tr>
              <td class=""email-masthead"" style=""word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;"" align=""center"">
                <a href=""https://www.niagaracollege.ca/"" class=""f-fallback email-masthead_name"" style=""color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;"">
                Niagara College PAC
              </a>
              </td>
            </tr>
                  ...
                  <tr>
                    <td class=""content-cell"" style=""word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;"">
                      <div class=""f-fallback"">
                        <p style=""font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;"">Please be advised that your account renewal status is expiring: """ + $"{MemberEmail}" + "\nLog in the system and edit your profile to submit the renewal form to update your account status for 3 more years or Cancel it. Please be sure to email your Supervisor in advanced.\nBest Regards!" + @"""</p>
                        <!-- Action -->
                        ...
                        <p style=""font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;"">Thanks,
                          <br />The Niagara College PAC Team</p>
                        <!-- Sub copy -->
