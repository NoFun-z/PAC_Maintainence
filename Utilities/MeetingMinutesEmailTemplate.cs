...
{
    public class MeetingMinutesEmailTemplate
    {
                  ...
                  <tr>
                    <td class=""content-cell"" style=""word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;"">
                      <div class=""f-fallback"">
                        <p style=""font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;"">Please be advised that new meeting minutes have now been uploaded for the most recent meeting: """ + $"{meetingName}" + @"""</p>
                        <!-- Action -->
