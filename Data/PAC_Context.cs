...
namespace NiagaraCollegeProject.Data
{
    public class PAC_Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MemberActionItems>()
.           HasKey(p => new { p.ID });

            modelBuilder.Entity<Member>()
                .HasMany<Meeting>(d => d.Meetings)
                .WithOne(p => p.Member)
        ...
        public DbSet<NiagaraCollegeProject.Models.MemberActionItems> MemberActionItems { get; set; }


        public DbSet<NiagaraCollegeProject.Models.Poll> Poll { get; set; }


        public DbSet<NiagaraCollegeProject.Models.PollOption> PollOption { get; set; }
    }
}