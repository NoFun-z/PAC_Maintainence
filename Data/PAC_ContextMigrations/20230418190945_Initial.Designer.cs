...
namespace NiagaraCollegeProject.Data.PAC_ContextMigrations
{
    ...
    [Migration("20230418190945_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.MeetingMinute", b =>
                {
                    ...
                    b.Property<string>("MeetingComment")
                        .HasMaxLength(200)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.MemberActionItems", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.Poll", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.PollOption", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.PollVote", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("OptionTextID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.PollOption", b =>
                {
                    b.HasOne("NiagaraCollegeProject.Models.Poll", "Poll")
                        .WithMany()
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.PollVote", b =>
                {
                    b.HasOne("NiagaraCollegeProject.Models.PollOption", "OptionText")
                        .WithMany()
                        .HasForeignKey("OptionTextID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NiagaraCollegeProject.Models.ActionItem", b =>
                {
                    ...
                    b.Navigation("MemberActionItems");
                });
