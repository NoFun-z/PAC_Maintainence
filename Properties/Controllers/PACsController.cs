...
namespace NiagaraCollegeProject.Controllers
{
    ...
    public class PACsController : Controller
    {
        ...
        // GET: PACs
        public async Task<IActionResult> Index(int? page, int? pageSizeID, string actionButton, string sortDirection = "asc", string sortField = "PAC ↕")
        {
        ...
        public async Task<IActionResult> Create([Bind("ID,PACName,AcademicDivisionID")] PAC pAC)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", new { pAC.ID });
            }
